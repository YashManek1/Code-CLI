...
// =============================================================================
// Complete SandboxManager stub — sandbox is not available on Windows.
// Every method called anywhere in the codebase is present here as a no-op that
// returns safe defaults (disabled / empty / passthrough).
// =============================================================================

const _noopViolationStore = {
  getViolations: () => [],
  getRecentViolationCount: () => 0,
  clearViolations: () => {},
  subscribe: () => () => {},
  addViolation: () => {},
  on: () => () => {},
...
export const SandboxManager = {
  ...
  // ── Dependencies ───────────────────────────────────────────────────────────
  checkDependencies: () => ({
    errors: ['Not supported on Windows'] as string[],
    warnings: [] as string[],
  }),

  // ── Config getters (sandbox disabled → empty / undefined) ──────────────────
  getFsReadConfig: () => ({ denyRead: [] as string[], allowRead: [] as string[] }),
  getFsWriteConfig: () => ({ allowOnly: [] as string[], denyWithinAllow: [] as string[] }),
  getNetworkRestrictionConfig: () => ({
    allowedDomains: [] as string[],
    deniedDomains: [] as string[],
  }),
  getAllowUnixSockets: () => undefined as string[] | undefined,
  getAllowLocalBinding: () => undefined as boolean | undefined,
  getIgnoreViolations: () => undefined,
  getEnableWeakerNestedSandbox: () => undefined as boolean | undefined,
  getExcludedCommands: () => [] as string[],
  getProxyPort: () => undefined as number | undefined,
  getSocksProxyPort: () => undefined as number | undefined,
  getLinuxHttpSocketPath: () => undefined as string | undefined,
  getLinuxSocksSocketPath: () => undefined as string | undefined,
  getLinuxGlobPatternWarnings: () => [] as string[],
...
// =============================================================================
// Standalone function exports (some callers import these directly)
// =============================================================================

export function addToExcludedCommands(command: string): string {
  return command;
}
...
export function wrapWithSandbox(command: string): Promise<string> {
  return Promise.resolve(command);
}

export function refreshConfig(): void {}
export function getSandboxUnavailableReason(): string | undefined {
  return 'Sandboxing is not supported in this environment.';
}

export function areSandboxSettingsLockedByPolicy(): boolean { return false; }
export function isAutoAllowBashIfSandboxedEnabled(): boolean { return false; }
export function areUnsandboxedCommandsAllowed(): boolean { return true; }
export function getExcludedCommands(): string[] { return []; }
export function scrubBareGitRepoFiles(): void {}
export function resolveSandboxFilesystemPath(p: string): string { return p; }
export function resolvePathPatternForSandbox(p: string): string { return p; }
export function shouldAllowManagedSandboxDomainsOnly(): boolean { return false; }
export function getLinuxGlobPatternWarnings(): string[] { return []; }
