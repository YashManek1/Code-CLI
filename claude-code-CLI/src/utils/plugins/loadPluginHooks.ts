...
export const loadPluginHooks = memoize(async (): Promise<void> => {
  logForDebugging('loadPluginHooks: calling loadAllPluginsCacheOnly...')
  const { enabled } = await loadAllPluginsCacheOnly()
  logForDebugging(`loadPluginHooks: loadAllPluginsCacheOnly returned ${enabled.length} enabled plugins.`)
